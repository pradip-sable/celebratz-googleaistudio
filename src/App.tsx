          ...
          <div className="space-y-6 pb-16">
            ...
            <div className="bg-white rounded-3xl p-4 sm:p-6 border border-stone-200 shadow-2xs space-y-4">
              <div className="flex flex-col sm:flex-row gap-3 items-center justify-between">
                ...
                <div className="relative flex-1 w-full">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-2.5 bg-stone-50 border border-stone-200 rounded-2xl text-xs sm:text-sm text-stone-900 font-medium placeholder:text-stone-400 focus:outline-hidden focus:border-teal-700 transition-colors"
                  />
                  {filters.searchQuery && (
                    <button
              ...
              {filters.searchQuery && filters.searchQuery.trim() && (
                <div className="flex flex-wrap items-center gap-2 p-3 bg-amber-50/70 border border-amber-200/80 rounded-2xl text-xs animate-in fade-in-50 duration-150">
                  ...
                  {parsedSearchQuery.detectedLocality && (
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-teal-900 text-teal-100 font-bold text-xs">
                  ...
                  {parsedSearchQuery.detectedCategory && (
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-stone-900 text-amber-300 font-bold text-xs">
                  ...
                  {parsedSearchQuery.detectedEventType && (
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-rose-900 text-rose-100 font-bold text-xs">
                      💍 {parsedSearchQuery.detectedEventType}
                    </span>
                  )}

                  {parsedSearchQuery.detectedGuestCount && (
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-emerald-900 text-emerald-100 font-bold text-xs">
                  ...
                  {parsedSearchQuery.keywords.length > 0 && (
                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full bg-stone-200 text-stone-800 text-xs">
                  ...
                  <button
                    onClick={() => setFilters(prev => ({ ...prev, searchQuery: '' }))}
                    className="ml-auto text-xs font-bold text-stone-500 hover:text-stone-950 flex items-center gap-1 cursor-pointer"
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 flex-wrap">
                <div className="px-2.5 py-1.5 rounded-xl bg-white flex items-center gap-2 shadow-sm border border-stone-200">
