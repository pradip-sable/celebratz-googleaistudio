  ...
  return (
    <div className="space-y-8 pb-16 animate-in fade-in duration-200">
      ...
      <div className="bg-white rounded-3xl p-6 sm:p-8 border border-stone-200 shadow-2xs space-y-4">
        ...
        <div className="pt-2 border-t border-stone-100 flex items-center gap-2 overflow-x-auto pb-1 no-scrollbar">
          <span className="text-xs font-bold text-stone-500 shrink-0">Celebration:</span>
          <button
            type="button"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {publicPackages.map(pkg => {
            ...
            return (
              <div
                key={pkg.id}
                className="bg-white rounded-3xl border border-stone-200 overflow-hidden shadow-xs hover:shadow-md transition-shadow flex flex-col justify-between group text-left"
              >
                <div>
                  ...
                  <div className="relative h-56 w-full bg-stone-900 overflow-hidden">
                    ...
                    <div className="absolute top-3.5 left-3.5 right-3.5 flex items-center justify-between gap-2">
                      ...
                      {/* Component count tag */}
                      <span className="px-2.5 py-1 rounded-full text-[10px] font-bold bg-stone-900/80 text-white backdrop-blur-xs border border-white/20">
                  ...
                  <div className="p-5 sm:p-6 space-y-4">
                    ...
                    <div className="space-y-2 bg-stone-50/90 rounded-2xl p-3.5 border border-stone-200/80">
                      <div className="flex items-center justify-between text-[11px] font-bold text-stone-700 uppercase tracking-wider">
                        ...
                        <span className="text-[10px] text-stone-600 font-normal lowercase">prices shown per component</span>
                      </div>
                      ...
                      <div className="space-y-1.5">
                        {priceData.components.map(({ listing, effectivePrice, priceUnit }) => (
                          <div 
                            key={listing.id}
                            className="flex items-center justify-between text-xs py-1 px-2 rounded-lg bg-white border border-stone-200/70"
                          >
                            <div className="flex items-center gap-2 truncate">
                              <span className="text-[10px] px-1.5 py-0.5 rounded font-bold uppercase bg-stone-100 text-stone-700">
                                {listing.category}
                              </span>
                      ...
                      <p className="text-[10px] text-stone-600 leading-tight pt-1 flex items-start gap-1">
                        <Info className="w-3 h-3 text-stone-600 shrink-0 mt-0.5" />
                        <span>
                    ...
                    <div className="p-3 rounded-2xl border flex items-center justify-between text-xs bg-white border-stone-200 shadow-2xs">
                ...
                <div className="p-5 sm:p-6 bg-stone-50/90 border-t border-stone-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <div>
                    <div className="flex items-center gap-1.5">
                  ...
                  <div className="flex items-center gap-2 w-full sm:w-auto">
                    <button
                      ...
                      className="flex-1 sm:flex-initial px-3.5 py-2.5 rounded-xl bg-white hover:bg-stone-100 text-stone-800 text-xs font-bold border border-stone-300 transition-colors cursor-pointer text-center"
                    >
                      View Details
                    </button>
                    <button
